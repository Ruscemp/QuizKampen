...
public class Single_GameMenuController {
    ...
    private Client main;
    private String startText = "In the top left corner you see your status\n" +
    ...
    ArrayList<Button> disabledCategories = new ArrayList<Button>();
    ...
    public void setSingleGameMenuThreads(){
        ...
        Client.threads.add(2, new Thread(this::exit));
    }
}
